// Lucide-flavored inline SVG icons. All paths use stroke=currentColor,
// stroke-width 1.75 (16/20px) or 2 (24px+). 24-unit viewBox.
const ICON_PATHS = {
...
function Icon({ name, size = 16, strokeWidth, style, ...rest }) {
